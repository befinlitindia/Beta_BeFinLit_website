    ...
    >
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-befinlit-cream border-b border-befinlit-navy/10 p-6 flex flex-col gap-4 shadow-lg animate-fade-in">
          ...
          <button onClick={() => handleLinkClick('tools')} className="text-left text-befinlit-navy font-bold hover:text-befinlit-gold py-3 border-b border-befinlit-navy/5">The Toolkit</button>
